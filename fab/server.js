(function (global, factory) {
    ...
    (global = global || self, factory(global.__fab = {}));
}(this, (function (exports) { 'use strict';

    var SandboxType;
    (function (SandboxType) {
        SandboxType[SandboxType["v8isolate"] = 0] = "v8isolate";
        SandboxType[SandboxType["nodeVm"] = 1] = "nodeVm";
    })(SandboxType || (SandboxType = {}));

    const NO_RESPONSE_STATUS_CODE = 444;
    const IMMUTABLE_HEADERS = {
        'cache-control': 'public, max-age=31536000, immutable',
    };
    const NON_IMMUTABLE_HEADERS = { 'cache-control': 'no-cache' };
    ...
    var extname = pathBrowserify.extname;
    ...
    const DEFAULT_INJECTIONS = { env: { name: 'FAB_SETTINGS' } };

    function generateReplacements(config, settings) {
    ...
    function RenderHTMLRuntime({ Router, Metadata }, args) {
        ...
        async function render(html, settings) {
            if (!html.tokens) {
        ...
        function stringify(tokens, values) {
    ...
    function RewireAssetsRuntime({ Router, Metadata, }) {
            ...
            if (renamed) {
                ...
                if (chunks_paths.length === 1) {
                    ...
                    if (immutable) {
                        ...
                        Object.entries(NON_IMMUTABLE_HEADERS).forEach(([k, v]) => response.headers.set(k, v));
                        return response;
                    }
                }
                else {
                    // If there are many chunks, we might want to limit parallelism
                    const responses = await Promise.all(chunks_paths.map(async (chunk_path) => {
                        return fetch(chunk_path);
                    }));
                    const concatenated_body = concatenateReadableStreams(responses.map((response) => response.body));
    ...
    const runtimes = [
          { plugin: RenderHTMLRuntime, args: {"fallback":"/index.html"} },
    { plugin: RewireAssetsRuntime, args: {} }
        ];

    const fab_metadata = {"file_metadata":{"/_assets/ico/favicon.e984a817f.png":{"content_length":1287,"content_type":"image/png"},"/_assets/ico/ipad-horizontal.e75439de3.png":{"content_length":66838,"content_type":"image/png"},"/_assets/ico/ipad-retina-horizontal.png":{"content_length":102310,"content_type":"image/png"},"/_assets/ico/poker114.8f8ee2cca.png":{"content_length":10251,"content_type":"image/png"},"/_assets/ico/poker144.ae6934ceb.png":{"content_length":13380,"content_type":"image/png"},"/_assets/ico/poker512.e9952ce36.png":{"content_length":38401,"content_type":"image/png"},"/_assets/ico/poker57.00cf60ae8.png":{"content_length":4847,"content_type":"image/png"},"/_assets/ico/poker72.4e9fb0fd4.png":{"content_length":6244,"content_type":"image/png"},"/_assets/js/bundle.6e8f84901.js":{"content_length":322797,"content_type":"application/javascript; charset=utf-8"}},"plugin_metadata":{"render_html":{"asset_html_paths":{},"inlined_htmls":{"/index.html":{"strings":["<!DOCTYPE html><html><head>","\n    <title>JS Video Poker</title>\n    <meta charset=\"utf-8\">\n    <meta name=\"description\" content=\"Open source video poker in HTML5/JavaScript\">\n    <meta name=\"keywords\" content=\"video poker, online, open source\">\n    <meta name=\"viewport\" content=\"width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\">\n    <meta name=\"apple-mobile-web-app-capable\" content=\"yes\">\n    <meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black-translucent\">\n    <link rel=\"shortcut icon\" href=\"ico/favicon.png\">\n    <link rel=\"apple-touch-icon-precomposed\" href=\"ico/poker57.png\">\n    <link rel=\"apple-touch-icon-precomposed\" sizes=\"72x72\" href=\"ico/poker72.png\">\n    <link rel=\"apple-touch-icon-precomposed\" sizes=\"114x114\" href=\"ico/poker114.png\">\n    <link rel=\"apple-touch-icon-precomposed\" sizes=\"144x144\" href=\"ico/poker144.png\">\n    <link href=\"ico/ipad-horizontal.png\" media=\"(device-width: 768px) and (device-height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 1)\" rel=\"apple-touch-startup-image\">\n    <link href=\"ico/ipad-retina-horizontal.png\" media=\"(device-width: 768px) and (device-height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 2)\" rel=\"apple-touch-startup-image\">\n    <link rel=\"stylesheet\" href=\"css/bundle.css\">\n    <link rel=\"canonical\" href=\"http://poker.hyprtxt.com\">\n  </head>\n  <body>\n    <div data-bind=\"visible: popup_visible\" class=\"score-popup\">\n      <div data-bind=\"text: message\"></div>\n    </div>\n    <div class=\"score-holder\">\n      <div class=\"scoring\">\n        <div class=\"column hand\">\n          <div>Bet</div>\n          <div>Royal Flush</div>\n          <div>Straight Flush</div>\n          <div>Four of a Kind</div>\n          <div>Full House</div>\n          <div>Flush</div>\n          <div>Straight</div>\n          <div>Three of a Kind</div>\n          <div>Two Pairs</div>\n          <div>Jacks or Better</div>\n        </div>\n        <div class=\"column\">\n          <div>1</div>\n          <div>250</div>\n          <div>50</div>\n          <div>25</div>\n          <div>9</div>\n          <div>6</div>\n          <div>4</div>\n          <div>3</div>\n          <div>2</div>\n          <div>1</div>\n        </div>\n        <div class=\"column\">\n          <div>2</div>\n          <div>500</div>\n          <div>100</div>\n          <div>50</div>\n          <div>18</div>\n          <div>12</div>\n          <div>8</div>\n          <div>6</div>\n          <div>4</div>\n          <div>2</div>\n        </div>\n        <div class=\"column\">\n          <div>3</div>\n          <div>750</div>\n          <div>150</div>\n          <div>75</div>\n          <div>27</div>\n          <div>18</div>\n          <div>12</div>\n          <div>9</div>\n          <div>6</div>\n          <div>3</div>\n        </div>\n        <div class=\"column\">\n          <div>4</div>\n          <div>1000</div>\n          <div>200</div>\n          <div>100</div>\n          <div>36</div>\n          <div>24</div>\n          <div>16</div>\n          <div>12</div>\n          <div>8</div>\n          <div>4</div>\n        </div>\n        <div class=\"column\">\n          <div>5</div>\n          <div>4000</div>\n          <div>250</div>\n          <div>125</div>\n          <div>45</div>\n          <div>30</div>\n          <div>20</div>\n          <div>15</div>\n          <div>10</div>\n          <div>5</div>\n        </div>\n        <div class=\"clearfix\"></div>\n      </div>\n      <div class=\"clearfix\"></div>\n      <div class=\"tab tab-scoring\">Scoring</div>\n    </div>\n    <div data-bind=\"text: credits_message\" class=\"credits message\"></div>\n    <div data-bind=\"text: message\" class=\"message\"></div>\n    <div class=\"cards\">\n      <div class=\"card_unit\">\n        <div class=\"container\">\n          <div data-bind=\"css: card1_class\" class=\"card back\">\n            <div class=\"card-inner\"></div>\n          </div>\n          <div data-bind=\"css: card1_class, event: { touchstart: card1_hold_toggle }, click: card1_hold_toggle\" class=\"card\">\n            <div class=\"card-inner\">\n              <div data-bind=\"text: card1_value_symbol\" class=\"value top\"></div>\n              <div class=\"suit\"></div>\n              <!-- <div class=\"bottom value\" data-bind=\"text: card#{i}_value_symbol\"></div>-->\n            </div>\n          </div>\n          <button data-bind=\"css: card1_class, click: card1_hold_toggle, event: { touchstart: card1_hold_toggle }, visible: hold_visible\">HOLD</button>\n        </div>\n      </div>\n      <div class=\"card_unit\">\n        <div class=\"container\">\n          <div data-bind=\"css: card2_class\" class=\"card back\">\n            <div class=\"card-inner\"></div>\n          </div>\n          <div data-bind=\"css: card2_class, event: { touchstart: card2_hold_toggle }, click: card2_hold_toggle\" class=\"card\">\n            <div class=\"card-inner\">\n              <div data-bind=\"text: card2_value_symbol\" class=\"value top\"></div>\n              <div class=\"suit\"></div>\n              <!-- <div class=\"bottom value\" data-bind=\"text: card#{i}_value_symbol\"></div>-->\n            </div>\n          </div>\n          <button data-bind=\"css: card2_class, click: card2_hold_toggle, event: { touchstart: card2_hold_toggle }, visible: hold_visible\">HOLD</button>\n        </div>\n      </div>\n      <div class=\"card_unit\">\n        <div class=\"container\">\n          <div data-bind=\"css: card3_class\" class=\"card back\">\n            <div class=\"card-inner\"></div>\n          </div>\n          <div data-bind=\"css: card3_class, event: { touchstart: card3_hold_toggle }, click: card3_hold_toggle\" class=\"card\">\n            <div class=\"card-inner\">\n              <div data-bind=\"text: card3_value_symbol\" class=\"value top\"></div>\n              <div class=\"suit\"></div>\n              <!-- <div class=\"bottom value\" data-bind=\"text: card#{i}_value_symbol\"></div>-->\n            </div>\n          </div>\n          <button data-bind=\"css: card3_class, click: card3_hold_toggle, event: { touchstart: card3_hold_toggle }, visible: hold_visible\">HOLD</button>\n        </div>\n      </div>\n      <div class=\"card_unit\">\n        <div class=\"container\">\n          <div data-bind=\"css: card4_class\" class=\"card back\">\n            <div class=\"card-inner\"></div>\n          </div>\n          <div data-bind=\"css: card4_class, event: { touchstart: card4_hold_toggle }, click: card4_hold_toggle\" class=\"card\">\n            <div class=\"card-inner\">\n              <div data-bind=\"text: card4_value_symbol\" class=\"value top\"></div>\n              <div class=\"suit\"></div>\n              <!-- <div class=\"bottom value\" data-bind=\"text: card#{i}_value_symbol\"></div>-->\n            </div>\n          </div>\n          <button data-bind=\"css: card4_class, click: card4_hold_toggle, event: { touchstart: card4_hold_toggle }, visible: hold_visible\">HOLD</button>\n        </div>\n      </div>\n      <div class=\"card_unit\">\n        <div class=\"container\">\n          <div data-bind=\"css: card5_class\" class=\"card back\">\n            <div class=\"card-inner\"></div>\n          </div>\n          <div data-bind=\"css: card5_class, event: { touchstart: card5_hold_toggle }, click: card5_hold_toggle\" class=\"card\">\n            <div class=\"card-inner\">\n              <div data-bind=\"text: card5_value_symbol\" class=\"value top\"></div>\n              <div class=\"suit\"></div>\n              <!-- <div class=\"bottom value\" data-bind=\"text: card#{i}_value_symbol\"></div>-->\n            </div>\n          </div>\n          <button data-bind=\"css: card5_class, click: card5_hold_toggle, event: { touchstart: card5_hold_toggle }, visible: hold_visible\">HOLD</button>\n        </div>\n      </div>\n    </div>\n    <div class=\"control-panel\">\n      <div class=\"buttons\">\n        <button data-bind=\"click: draw, event: { touchend: draw }, visible: draw_visible\">DRAW</button>\n        <button data-bind=\"click: holdAll, event: { touchend: holdAll }, visible: hold_visible\">HOLD ALL</button>\n        <button data-bind=\"click: newGame, event: { touchend: newGame }, visible: new_game_visible\">DEAL</button>\n        <button data-bind=\"click: incrementBet, event: { touchend: incrementBet }, visible: bet_increment_visible\">Bet <span data-bind=\"text: bet\">1</span></button>\n      </div>\n    </div>\n    <div class=\"message bottom\"><span data-bind=\"text: max_credits_message\"></span> <span class=\"text-right\">Hands Played: <span data-bind=\"text: hands_played\"></span></span></div>\n    <div class=\"options-holder\">\n      <div class=\"tab tab-options\">Options</div>\n      <div class=\"options\">\n        <div class=\"option-container\">\n          <label>Show Score Popup \n            <div data-bind=\"css: { checked: show_score_popup() === true }\" class=\"checkbox\">\n              <input type=\"checkbox\" data-bind=\"checked: show_score_popup\">\n              <div class=\"checkmark\">&#x2713;</div>\n            </div>\n          </label>\n        </div>\n        <div class=\"stats\">\n          <p><span data-bind=\"text: max_credits_message\"></span></p>\n          <p>Hands Played: <span data-bind=\"text: hands_played\"></span></p>\n          <p>Free Credits Taken:<span data-bind=\"text: free_credits_obtained\"></span></p>\n        </div>\n        <div class=\"clearfix\"></div>\n      </div>\n      <div class=\"clearfix\"></div>\n    </div>\n    <div class=\"footer\">\n      <p class=\"footer-info\">Site last modified: <span>Thu Dec 17 2020 10:31:36 GMT-0700 (Mountain Standard Time)</span></p>\n    </div>\n    <script src=\"http://localhost:35729/livereload.js\"></script>\n    <script src=\"js/bundle.js\"></script>\n  \n</body></html>"],"varNames":["FAB_ENV_INJECTION"]}},"resolved_fallback":"/index.html"},"rewire_assets":{"inlined_assets":{"/_poker.appcache":{"content_type":"text/cache-manifest; charset=utf-8","contents":"CACHE MANIFEST\n\n# app\nindex.html\n\n# styles\npoker.css\n\n# javascript\nbundle.js\n\n# suits\nheart.svg\nclub.svg\ndiamond.svg\nspade.svg\n\n# icons\nico/favicon.png\nico/poker57.png\nico/poker72.png\nico/poker114.png\nico/poker144.png\nico/ipad-horizontal.png\nico/ipad-retina-horizontal.png\n\nNETWORK:\\n*\\n\n","immutable":false},"/css/bundle.css":{"content_type":"text/css; charset=utf-8","contents":"* {\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n}\nbody {\n  margin: 0;\n  background: #00f;\n  font-family: sans-serif;\n  color: #ff0;\n  text-transform: uppercase;\n  text-shadow: 2px 2px 0 #000;\n}\n.score-popup {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: rgba(0,0,0,0.3);\n  z-index: 5;\n  font-size: 14px;\n}\n.score-popup div {\n  text-align: center;\n  position: absolute;\n  width: 40%;\n  height: 20%;\n  background: #f00;\n  left: 30%;\n  top: 30%;\n  z-index: 1;\n}\n.footer {\n  display: none;\n}\n.howto {\n  display: none;\n}\n.score-holder {\n  position: relative;\n}\n.scoring {\n  border-bottom: 2px solid #ff0;\n  font-size: 12px;\n}\n.column {\n  border-left: 2px solid #ff0;\n  text-align: center;\n  width: calc(14% - 2px);\n  float: left;\n}\n.hand {\n  text-align: left;\n  width: 30%;\n  float: left;\n  border-width: 0;\n}\n.column > div:first-child {\n  border-bottom: 2px solid #ff0;\n}\n.column > div:nth-child(even) {\n  background: #00009a;\n}\n.column > div:nth-child(odd) {\n  background: #000080;\n}\n.text-right {\n  float: right;\n}\n.clearfix:before,\n.clearfix:after {\n  display: table;\n  content: \" \";\n}\n.clearfix:after {\n  clear: both;\n}\n.score-holder {\n  position: relative;\n}\n.tab {\n  background: #000080;\n  border: 2px solid #ff0;\n  position: absolute;\n  font-size: 16px;\n  text-align: center;\n  padding: 3px 4px;\n  cursor: pointer;\n}\n.tab-scoring {\n  bottom: -26px;\n  border-radius: 0 0 5px 5px;\n  border-top: 0;\n  right: 25%;\n}\n.tab-options {\n  top: -26px;\n  border-radius: 5px 5px 0 0;\n  border-bottom: 0;\n  right: 34%;\n}\n.options {\n  border-top: 2px solid #ff0;\n  background: #000080;\n  padding: 10px;\n}\n.options-holder {\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n}\n.message {\n  text-transform: uppercase;\n  font-size: 14px;\n  width: 98%;\n  margin: 0;\n  padding: 1%;\n}\n.message.bottom {\n  clear: both;\n  position: fixed;\n  bottom: 0;\n}\n.credits {\n  float: right;\n  text-align: right;\n  width: 30%;\n}\n.cards,\n.buttons {\n  clear: both;\n  margin: 0 auto;\n}\n.cards {\n  margin-bottom: 10px;\n}\n.card_unit {\n  float: left;\n  width: 20%;\n  position: relative;\n  perspective: 600;\n  -webkit-perspective: 600;\n}\n.card_unit button.hold {\n  background: #e5e600;\n  border-color: #f00;\n}\n.option-container {\n  position: relative;\n}\n.checkbox {\n  display: inline-block;\n  border-radius: 5px;\n  box-shadow: inset 0px 0px 4px #999;\n  width: 20px;\n  height: 20px;\n  background: #fff;\n  border: 1px solid #ff0;\n  line-height: 1.4;\n}\n.checkbox.checked {\n  background: #333;\n  box-shadow: inset 0px 0px 4px #fff;\n}\n.checkmark {\n  display: none;\n  text-align: center;\n  width: 20px;\n  position: absolute;\n}\n.checkbox.checked .checkmark {\n  display: block;\n}\n.checkbox input {\n  display: none;\n}\n.checkbox input:checked {\n  background: #333;\n}\n.card {\n  width: 98%;\n  background-color: #fff;\n  border-radius: 5px;\n  margin: 1%;\n  position: relative;\n  padding-bottom: 135%;\n  transition: transform 0.6s;\n  -webkit-transition: -webkit-transform 0.6s;\n  transform-style: preserve-3d;\n  -webkit-transform-style: preserve-3d;\n  transform: rotateY(180deg);\n  -webkit-transform: rotateY(180deg);\n  backface-visibility: hidden;\n  -webkit-backface-visibility: hidden;\n}\n.card .card-inner {\n  box-shadow: inset 0 0 2px 0 #222;\n  background: #fff;\n  position: absolute;\n  border-radius: 5px;\n  height: 97%;\n  width: 96%;\n  top: 1.5%;\n  left: 2%;\n}\n.card .suit {\n  width: 73%;\n  height: 68%;\n  background-size: 100% 100%;\n  background-repeat: no-repeat;\n  position: absolute;\n  left: 13.5%;\n  top: 20%;\n}\n.card .value {\n  position: absolute;\n  font-size: 30px;\n  text-shadow: none;\n  font-weight: bold;\n}\n.card .value.top {\n  top: 0px;\n  left: 10px;\n}\n.card.undefined .value {\n  display: none;\n}\n.card.diamonds,\n.card.clubs,\n.card.hearts,\n.card.spades {\n  transform: rotateY(0deg);\n  -webkit-transform: rotateY(0deg);\n}\n.card.hold {\n  background: #f00;\n}\n.card.back {\n  backface-visibility: visible;\n  -webkit-backface-visibility: visible;\n  position: absolute;\n  margin: 0 1%;\n  z-index: -1;\n}\n.card.back .card-inner {\n  background: #000080;\n}\nbutton {\n  width: 100%;\n  background: #ff0;\n  padding: 15px;\n  border: 2px solid #00f;\n  font-weight: bold;\n}\nbutton:hover {\n  background: #f0f000;\n}\n.buttons button {\n  float: right;\n  width: 45%;\n}\n.undefined .card-inner {\n  background: #000080;\n}\n.diamonds .suit {\n  background-image: url(\"../img/diamond.svg\");\n}\n.clubs .suit {\n  background-image: url(\"../img/club.svg\");\n}\n.hearts .suit {\n  background-image: url(\"../img/heart.svg\");\n}\n.spades .suit {\n  background-image: url(\"../img/spade.svg\");\n}\n.diamonds .value,\n.hearts .value {\n  color: #f00;\n}\n.clubs .value,\n.spades .value {\n  color: #000;\n}\n@media (min-width: 568px) {\n  .cards {\n    margin-bottom: 0;\n  }\n  button {\n    padding: 12px;\n  }\n}\n@media (min-width: 480px) {\n  .card .value {\n    font-size: 35px;\n  }\n  button,\n  .message,\n  .tab,\n  .scoring,\n  .score-popup,\n  .options {\n    font-size: 16px;\n  }\n}\n@media (min-width: 760px) {\n  .card .value {\n    font-size: 50px;\n  }\n  button,\n  .message,\n  .tab,\n  .scoring,\n  .score-popup,\n  .options {\n    font-size: 22px;\n  }\n  .tab-scoring {\n    padding: 4px 12px;\n    bottom: -35px;\n  }\n  .tab-options {\n    padding: 4px 12px;\n    top: -35px;\n  }\n  .card {\n    border-radius: 15px;\n  }\n  .card .card-inner {\n    border-radius: 15px;\n  }\n}\n@media (min-width: 980px) {\n  .card .value {\n    font-size: 70px;\n  }\n  button,\n  .message,\n  .tab,\n  .scoring,\n  .score-popup,\n  .options {\n    font-size: 32px;\n  }\n  .tab-                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       